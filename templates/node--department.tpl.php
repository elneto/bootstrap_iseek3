...
<div class="row">
       	<div class="col-lg-12">
      		<div class="toolkit large-text">&nbsp;<?php echo $node->title; ?></div>
	</div>
	<div class="col-lg-12">
				...
				<div class="row">
						...
						<?php if (count($node->field_departmental_where_image)) { ?>
							<a href="<?php echo $node->field_departmental_where_link['und'][0]['url'] ; ?>">
								<img class="departmental_where_image" src="<?php print image_style_url('large-article-image-style-16-9', $node->field_departmental_where_image['und'][0]['uri']); ?>" />
