...
?>
<br/>
<b><?php print $row->field_field_bulletin_source[0]['rendered']['#markup'] ?></b>: 
<a href="https://iseek.dev.un.org/<?php echo $alias; ?>"><font size="2" color="#4F4F4F" face="Verdana">https://iseek.dev.un.org/<?php echo $alias; ?></font></a>
