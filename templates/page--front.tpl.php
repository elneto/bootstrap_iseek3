      ...
      <div class="row">      
        ...
        <div class="col-lg-4">
          ...
          <div class="twitter-border fluid collapse in" id="socialmedia-box">
		      <a class="twitter-timeline" data-chrome="nofooter noborders" 
          data-widget-id="<?php print t('590192526923063296');?>" height="670" 
          href="<?php print t('https://twitter.com/UN');?>" 
          width="100%">
          <?php print t('Tweets by @UN');?></a> 
          <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></p>	
          </div>
        <div class="large-text social"> <a href="<?php print t('http://www.facebook.com/unitednations');?>" target="_blank"><i class="fa fa-facebook-square fa-2x facebook"></i><span class="screen-reader-only">Link to the United Nations Facebook page</span></a> <a href="<?php print t('http://twitter.com/#!/un');?>"><i class="fa fa-twitter-square fa-2x twitter"></i><span class="screen-reader-only">Link to the United Nations Twitter account</span></a> <a href="<?php print t('http://www.youtube.com/unitednations');?>"><i class="fa fa-youtube-square fa-2x youtube"></i><span class="screen-reader-only">Link to the United Nations Youtube account</span></a> <a href="<?php print t('http://gplus.to/unitednations');?>"><i class="fa fa-google-plus-square fa-2x googleplus"></i><span class="screen-reader-only">Link to the United Nations Google+ account</span></a> <a href="<?php print t('http://instagram.com/unitednations');?>"><i class="fa fa-instagram fa-2x instagram"></i><span class="screen-reader-only">Link to the United Nations Instagram account</span></a> </div>
        </div>
