...
<!-- Stories, search, events, announcements -->
      ...
      <div class="row">
        <div class="col-lg-12 margin-submit">
          <div class="large-text submit-content">&nbsp;<i class="fa fa-pencil-square-o fa-lg"> </i>&nbsp;&nbsp;<a href="#">Submit content <i class="fa fa-angle-double-right"></i></a> <span class="less-large"><span class="hidden-xs">&nbsp;&nbsp;<?php print render($submit_content_body); ?></span></span></div>
        </div>
      </div>
      <!-- END Submit -->
     <!-- ******************************************************************************************************
